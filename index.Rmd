...
It is very easy to mess up your C++ and R library within the `conda`
environment. Even `tidyverse` doesn't work as expected in the conda
version.  Use regular `R` installation that deposits library files in
