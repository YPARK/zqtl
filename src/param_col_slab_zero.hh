...
void impl_initialize_param(Parameter& P, const tag_param_col_slab_zero) {
...
auto make_dense_col_slab_zero(const Index n1, const Index n2, const Opt& opt) {
...
// factory functions
template <typename Scalar, typename Index, typename Opt>
auto make_dense_col_slab_zero_ptr(const Index n1, const Index n2,
                                  const Opt& opt) {
  using Mat = Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic>;
  using Param = param_col_slab_zero_t<Mat, tag_param_dense>;
...
auto make_sparse_col_slab_zero(const Eigen::SparseMatrixBase<Derived>& A,
                               const Opt& opt) {
...
template <typename Parameter>
void impl_resolve_param(Parameter& P, const tag_param_col_slab_zero) {
...
template <typename Parameter>
void impl_resolve_hyperparam(Parameter& P, const tag_param_col_slab_zero) {
...
template <typename Parameter>
const auto& impl_mean_param(Parameter& P, const tag_param_col_slab_zero) {
  return P.beta;
}

template <typename Parameter>
const auto& impl_var_param(Parameter& P, const tag_param_col_slab_zero) {
  return P.theta_var;
}
...
void impl_eval_param_sgd(Parameter& P, const M1& G1, const M2& G2,
                         const M3& Nobs, const tag_param_col_slab_zero) {
  ////////////////////////////////
...
template <typename Parameter>
void impl_check_nan_param(Parameter& P, const tag_param_col_slab_zero) {
