...
void eval_param_sgd(P& p, const Eigen::MatrixBase<D1>& g1,
...
template <typename P, typename D1, typename D2, typename D3>
void eval_param_sgd(P& p, const Eigen::SparseMatrixBase<D1>& g1,
...
void safe_eval_param_sgd(Parameter& P, const Eigen::MatrixBase<Deriv1>& G1,
                         const Eigen::MatrixBase<Deriv2>& G2,
                         const Eigen::MatrixBase<Deriv3>& Nobs,
                         const tag_param_dense) {
  impl_eval_param_sgd(P, G1.derived(), G2.derived(), Nobs.derived(),
                      sgd_tag<Parameter>());
}

template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void safe_eval_param_sgd(Parameter& P,
...
// dispatch functions for SGD evaluation
template <typename P, typename D1, typename D2, typename D3>
void eval_hyperparam_sgd(P& p, const Eigen::MatrixBase<D1>& g1,
                         const Eigen::MatrixBase<D2>& g2,
                         const Eigen::MatrixBase<D3>& nobs) {
...
template <typename P, typename D1, typename D2, typename D3>
void eval_hyperparam_sgd(P& p, const Eigen::SparseMatrixBase<D1>& g1,
                         const Eigen::SparseMatrixBase<D2>& g2,
                         const Eigen::SparseMatrixBase<D3>& nobs) {
  safe_eval_hyperparam_sgd(p, g1, g2, nobs, sparsity_tag<P>());
}
...
// check to match sparsity of the parameter and gradient
template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void safe_eval_hyperparam_sgd(Parameter& P, const Eigen::MatrixBase<Deriv1>& G1,
                              const Eigen::MatrixBase<Deriv2>& G2,
                              const Eigen::MatrixBase<Deriv3>& Nobs,
                              const tag_param_dense) {
  impl_eval_hyperparam_sgd(P, G1.derived(), G2.derived(), Nobs.derived(),
                           sgd_tag<Parameter>());
}

template <typename Parameter, typename Deriv1, typename Deriv2, typename Deriv3>
void safe_eval_hyperparam_sgd(Parameter& P,
                              const Eigen::SparseMatrixBase<Deriv1>& G1,
                              const Eigen::SparseMatrixBase<Deriv2>& G2,
                              const Eigen::SparseMatrixBase<Deriv3>& Nobs,
                              const tag_param_sparse) {
...
void perturb_param(Parameter& P, const Scalar sd, RNG& rng) {
