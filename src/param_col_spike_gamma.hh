...
void impl_initialize_param(Parameter& P, const tag_param_col_spike_gamma) {
...
template <typename Parameter>
void impl_resolve_hyperparam(Parameter& P, const tag_param_col_spike_gamma) {
...
template <typename Parameter>
void impl_check_nan_param(Parameter& P, const tag_param_col_spike_gamma) {
...
template <typename Parameter>
const auto& impl_mean_param(Parameter& P, const tag_param_col_spike_gamma) {
  return P.theta;
}

template <typename Parameter>
auto impl_log_odds_param(Parameter& P, const tag_param_col_spike_gamma) {
  return P.alpha_aux_col;
}

template <typename Parameter>
const auto& impl_var_param(Parameter& P, const tag_param_col_spike_gamma) {
  return P.theta_var;
}
...
void impl_eval_param_sgd(Parameter& P, const M1& G1, const M2& G2,
                         const M3& Nobs, const tag_param_col_spike_gamma) {
  ////////////////////////////////////////////////////////////////
